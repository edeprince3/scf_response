...
UKSResponseSolver::UKSResponseSolver(std::shared_ptr<Wavefunction> reference_wavefunction, Options& options_):
...
UKSResponseSolver::~UKSResponseSolver() {
}

std::vector<std::vector<double>> UKSResponseSolver::first_order_response(std::vector<std::shared_ptr<Matrix>> op_a, std::vector<std::shared_ptr<Matrix>> op_b, double omega) {
...
void UKSResponseSolver::compute_polarizability(std::vector<double>X, std::vector<double>Y, double omega){
...
void UKSResponseSolver::compute_hyperpolarizability(
...
void UKSResponseSolver::build_Au_Bu(int N, int L, double *u, double *ABu){
