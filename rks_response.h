...
#ifndef RKS_RESPONSE_H
#define RKS_RESPONSE_H
...
class RKSResponseSolver: public KSResponseSolver {

  public:

    RKSResponseSolver(std::shared_ptr<Wavefunction> reference_wavefunction, Options& options_);
